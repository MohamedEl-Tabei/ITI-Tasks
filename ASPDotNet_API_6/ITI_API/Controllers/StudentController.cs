...
namespace ITI_API.Controllers
{
    ...
    public class StudentController : ControllerBase
    {
        ...
        [HttpPost]
        [ServiceFilter(typeof(FilterPrintArguements))]
        public Results<Ok<GeneralResult<DTOStudentCreate>>,BadRequest<GeneralResult<DTOStudentCreate>>> Add(DTOStudentCreate newData)
        {
            var result = _manager.Add(newData);
        ...
        public Ok<string> GetFromHeader(
        [FromHeader(Name = "Mydata")] string data)
        {
            return TypedResults.Ok($"My Data = {data}");
        }
    }
}
